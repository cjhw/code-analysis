...
```bash
npm i --save code-analysis

```

在需要分析代码的项目跟目录添加 analysis.config.js
  ...
  scanSource: [
    {
      ...
      httpRepo: `https://github.com/cjhw/demo/blob/${getGitBranch()}/`, // 可选，项目gitlab/github url的访问前缀，用于点击行信息跳转，不填则不跳转
    },
  ],
